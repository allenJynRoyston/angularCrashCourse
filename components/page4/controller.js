myApp.controller('page4Controller', function($scope, $timeout) {
	...
	$scope.ngClassConditional = "<style>\n.blueOutline{\n  border: 1px solid blue\n}\n\n.redOutline{\n  border: 1px solid red\n}\n</style>\n\n<div class='col-xs-6'\n ng-class=\"{true: 'blueOutline', false: 'redOutline'}[myCondition]\">\n  Condition: {{myCondition}}\n<hr>\n<i class='fa fa-2x' \nng-class='{true: \"fa-thumbs-o-up\", false: \"fa-thumbs-o-down\" }[myCondition]'></i>\n<br>\n</div>";
